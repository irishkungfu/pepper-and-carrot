...
$(document).ready(function() {
  $(".character-wrapper").click(function() {
    var area = $(this)
      .parent()
      .prop("id"); // Identify which section you are in
    // var getHtml;
    ...
    if (area === "select-your-character_area") {
      ...
      if (characterCount === 0) {
        ...
        var placeholder =
          '<div class="px-1 col-3 character-wrapper invisible"><div class="card p-1"><div class="card-body"><img src="assets/images/pepper.jpg" class="img-fluid character-image" alt=""><div class="caption">Pepper<br><small">HP - 100</small></div></div></div></div>';
        $(this)
          .parent()
    ...
    if (phase === "attack") {
      ...
      $("#battle-status").text(
        "You attacked " +
          ...
          " damage! " +
          defender.name +
          " responded with a counter attack, you took " +
      ...
      if (defender.hp <= 0) {
        ...
        if (defenderCounter === 0) {
          $("#battle-status").text(
            "You have have defeated all the other witches!"
          );
        }
      }
